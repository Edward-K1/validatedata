...
class BaseTest(unittest.TestCase):
    def setUp(self):
        ...
        self.compressed_int_rule = (
            'int:5:to:100:msg:should be an int 5 to 100 digits long'
        )
        self.expanded_str_with_len_rule = [{'type': 'str', 'message': '', 'length': 20}]
        ...
        self.all_object_rules = [{**self.object_rule, 'object': Person}]
